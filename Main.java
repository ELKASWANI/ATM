/*
 The program Main.java about: An ATM machine simulation with
 an Account class with all the attributes that characterize a
 bank account, and all the methods needed, including toString()
 and equals(), and operations such as deposit, withdraw and print balance.
